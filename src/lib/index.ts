...
// Export Mermaid processor
export { 
  MermaidProcessor, 
  processMermaidCode, 
  needsProcessing,
  type MermaidProcessorOptions,
  type MermaidProcessorResult 
...
// Modified to exclude currency patterns like $15M, $184K, etc.
const inlineRuleNonStandard = /^(?:\$(?!\$)(?![\d,]+\.?\d*[KMBT]?\b)([^\$\n]+?)\$|\\\((.+?)\\\))/;
